 ...
 * **Details**
 *
 * Content: Manage Plan in a Domain
 */
@Injectable()
export class ContentPlanApi extends BaseLoopBackApi {
  constructor(
   ...
   * This usually means the response is a `ContentPlan` object.)
   * </em>
   */
  public getStorageFile(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET'
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPlans/:id/storageFile'
  ...
  public getSystemDomain(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET'
    let _url: string =
      LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPlans/:id/systemDomain'
    let _routeParams: any = {
      id: id,
    }
    let _postBody: any = {}
  ...
  public getSystemUser(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET'
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPlans/:id/systemUser'
    let _routeParams: any = {
      id: id,
    }
    let _postBody: any = {}
  ...
  public patchOrCreate(data: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPlans'
    let _routeParams: any = {}
    let _postBody: any = {
      data: data,
    }
  ...
  public patchAttributes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'PATCH'
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPlans/:id'
    let _routeParams: any = {
      id: id,
    }
    let _postBody: any = {
  ...
  public _template_basic_remote(options: any = {}, params: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'GET'
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() + '/ContentPlans/_template_basic'
    let _routeParams: any = {}
    let _postBody: any = {}
    let _urlParams: any = {}
